...
<!-- /.modal-content -->
	...
	<?php 
		...
		if (!empty($_FILES['image']['tmp_name'])) {
			...
			$conn->query("UPDATE candidate SET position = '$position', firstname = '$firstname', lastname = '$lastname', Age = '$age', gender = '$gender' WHERE candidate_id = '$candidate_id'") or die($conn->error);
		}
